本项目基于上游X-UI项目（ https://github.com/vaxilu/x-ui ）进行略微的功能改动！后续将紧跟上游X-UI的底层协议内容及BUG的版本更新！
...
```
bash <(curl -Ls https://raw.githubusercontents.com/chongdon1230/x-ui-yg/main/install.sh)
```
